...
class TurtleWall:
    ...
    def createMirroredFeatures(self, wallData:WallData)->tuple[f.ExtrudeFeature, f.RectangularPatternFeature]:
        ...
        slotFeature = self.tComponent.extrudeAllProfiles(wallData.tSketch, self.wallThicknessExpr, 1)
