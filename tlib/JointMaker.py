...
class JointMaker:
    ...
    def createWalls(self, profile):
        layers, newFeatures = TurtleLayers.createFromProfiles(self.baseComponent, profile, [pOUTER, pMID, pOUTER])
        # wall cuts
    ...
    def createHalfShelf(self, line:f.SketchLine, index) -> TurtleLayers:
        ...
        layers, newFeatures = TurtleLayers.createFromProfiles(tcomp, [fullProfile,cutProfile,fullProfile], [pOUTER, pMID, pOUTER])
        return layers
